...
from datasets.multi_digit_dataset import MultiDigitDataset
...
def get_args_parser():
    ...
    parser.add_argument('--output-dir', default='/content/drive/My Drive/Colab Notebooks/outputs/Multi-MNIST',
